...
final class InsightDumper
{
     ...
     */
    public static function dump(mixed $vars, string $file = 'N/A', int $line = 0, float $executionTime = 0.0): string
    {
        ...
        $output .= "<p>Execution time: " . sprintf("%.4f seconds", $executionTime) . "</p>";
